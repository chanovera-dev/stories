	...
	<header class="entry-header">
		<div class="entry-header-top">
			...
			<div class="entry-reading-time">
				<?php echo stories_get_svg( 'clock', array( 'size' => 14 ) ); ?>
				<span><?php echo esc_html( stories_reading_time() ); ?></span>
			</div>
		</div>
		...
		<div class="entry-meta-card">
			<div class="meta-author-side">
				...
				<div class="author-info">
					<span class="author-byline"><?php esc_html_e( 'Escrito por', 'stories' ); ?></span>
			...
			<div class="meta-details-side">
				...
				<?php if ( comments_open() || get_comments_number() ) : ?>
					<a href="#comments" class="meta-item meta-comments" aria-label="<?php esc_attr_e( 'Ir a comentarios', 'stories' ); ?>">
						...
						<span><?php echo esc_html( get_comments_number_text( __( '0', 'stories' ), __( '1', 'stories' ), __( '%', 'stories' ) ) ); ?></span>
					</a>
				<?php endif; ?>
