<?php
/**
 * Template part for displaying posts in a Justified Grid (loop00)
 *
...
<div class="ajax-item-wrapper" 
	...
	<?php
	// Render format-specific Stories content card (falling back cleanly to root design if loop00 lacks full-bleed cards)
	if ( 'gallery' === $format ) {
