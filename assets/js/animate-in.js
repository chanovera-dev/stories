/**
 * Utility to progressively animate in elements when entering viewport using IntersectionObserver.
 *
 * @param {string|NodeList|Array|HTMLElement} selectors
 * @param {Array<string>} animationClasses
