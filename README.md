# Stories V2.1.1 WordPress Theme
...
*   **Bloques Gutenberg Personalizados:**
    ...
    *   **Últimas Entradas:** Filtrado avanzado para excluir ciertos formatos de "micro-contenido" (artículos del tipo 'aside', 'quote', 'link', 'image', 'video', 'audio').
