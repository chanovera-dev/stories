...
function stories_get_color_schemes() {
	return array(
		...
		'nordic'    => array(
			'label'       => __( 'Azure Ocean / Azul Zafiro & Océano', 'stories' ),
			'description' => __( 'Gama oceánica con azul eléctrico vibrante, azul zafiro y azul marino elegante.', 'stories' ),
			'preview'     => array(
				'primary' => '#0079ff',
				'accent'  => '#0050b3',
				'header'  => '#eaf2fb',
			...
			'vars'        => array(
				...
				'--bg-body'                    => '#f4f8fc',
				'--header-background'          => '#eaf2fb',
				'--footer-background'          => '#06152d',
		...
		'sunset'    => array(
			'label'       => __( 'Sunset Amber (Zuky) / Ámbar & Granate', 'stories' ),
			'description' => __( 'Paleta cálida y luminosa de Zuky con tonos ámbar, arena, contraste avellana y pie granate profundo.', 'stories' ),
			'preview'     => array(
				'primary' => '#feda7c',
				'accent'  => '#F90093',
				'header'  => '#fffbf0',
			...
			'vars'        => array(
				'--color-primary'              => '#feda7c',
				'--color-primary-hover'        => '#cbae63',
				'--color-primary-light'        => '#fef4db',
				'--color-primary-accent'       => '#AF3E4D',
				'--color-primary-accent-light' => '#F90093',
				'--color-secondary'            => '#fdecbd',
				'--color-tertiary'             => '#fef4db',
				'--color-quaternary'           => '#ebdfbe',
				'--color-text-heading'         => '#655731',
				'--color-text-body'            => '#655731',
				'--color-text-muted'           => '#9e8c5e',
				'--bg-body'                    => '#fffbf0',
				'--bg-card'                    => '#ffffff',
				'--border-light'               => '#ebdfbe',
				'--header-background'          => '#fef4db',
				'--footer-background'          => '#3f0d12',
				'--accent-background-1'        => '#AF3E4D',
				'--accent-background-2'        => '#F90093',
				'--bright-line'                => '#ffffff',
				'--shadow-color'               => '#655731',
			),
		),
